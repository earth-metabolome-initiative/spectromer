"""Setup for the spectromer package."""
...
__version__ = find_version("spectromer", "__version__.py")
...
setup(
    ...
    url="https://github.com/LucaCappelletti94/spectromer",
    ...
    entry_points={
        "console_scripts": [
            "spectromer=spectromer.cli:main",
        ],
    },
)
